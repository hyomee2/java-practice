package org.example.chap04_control_flow.section01.conditional.level04.advanced;
...
public class Application2 {
    public static void main(String[] args) {
        ...
        // 보너스 금액 bonusAmount 선언 및 할당
        int bonusAmount = (int)(revenue * bonusRate * 0.01);
